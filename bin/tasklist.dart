void main() {
  ...
  print("The value of list after replacing the items between the range [4-6] is $names");
  ...
  print("The value of list after removing the list element between the range 4-6 $names");
}
